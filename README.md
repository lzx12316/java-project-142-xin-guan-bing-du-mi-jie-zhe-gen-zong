...
本项目是 **新冠病毒密接者跟踪系统**，采用主流 Java Web 技术栈开发，功能完整、结构清晰，非常适合作为毕业设计或课程设计的参考源码。

**仓库名**：`java-project-142-xin-guan-bing-du-mi-jie-zhe-gen-zong`

**原始压缩包名**：`springboot142新冠病毒密接者跟踪系统`

---

## 🛠️ 技术栈

- **后端**：Java、Maven、Spring Boot、Spring Boot Web、Thymeleaf
